...
](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=accelerate_example)

This example does distributed data parallel training with Hugging Face Accelerate, Ray Train, and Ray Data. It fine-tunes a BERT model and is adapted from [huggingface/accelerate](https://github.com/huggingface/accelerate/blob/main/examples/nlp_example.py)
...
## See also
  ...
  * Get Started with Hugging Face Accelerate for a tutorial on using Ray Train and HF Accelerate
