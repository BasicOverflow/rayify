...
You need to set [Code search path](configure.md#code-search-path) in your driver.
...
Note
  ...
  * BigInteger can support a max value of 2^64-1. See: [msgpack/msgpack](https://github.com/msgpack/msgpack/blob/master/spec.md#int-format-family). If the value is larger than 2^64-1, then sending the value to Python raises an exception.
